...
export default function Hero() {
  const [text] = useTypewriter({
    words: ["Full Stack Developer", "AI Engineer", "React & Node.js", "Spring Boot", "Problem Solver"],
    loop: 0,
    typeSpeed: 65,
    deleteSpeed: 35,
  });
    ...
    <div className="section-wrap w-full flex flex-col-reverse lg:flex-row items-center gap-14 lg:gap-8">
      ...
      >
        ...
        <motion.div variants={fadeUp}
          className="flex items-center gap-2 text-xs font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 px-3.5 py-1.5 rounded-full w-fit"
        >
      ...
      >
        ...
        >
          <span className="text-base">🧩</span>
          <div className="leading-tight">
            <p className="text-xs font-bold text-slate-800">500+ DSA</p>
